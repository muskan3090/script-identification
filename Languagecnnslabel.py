...
imagePaths = sorted(list(paths.list_images("E:/Progs/Restore/ManuscriptDataset/dataset16")))
...
mc = ModelCheckpoint('E:/Progs/Restore/best_model31.h5', monitor='val_accuracy', mode='max', save_best_only=True)
...
for title, normalize in titles_options:
    ...
    plt.savefig("E:/Progs/Restore/ManuscriptDataset/Resultcnnslabel/confusion_matrix10_norm_31")
...
for title, normalize in titles_options:
    ...
    plt.ylabel('True label')
    print(disp.confusion_matrix)
    plt.savefig("E:/Progs/Restore/ManuscriptDataset/Resultcnnslabel/confusion_matrix10_31")

plt.show()
# save the model to disk
print("[INFO] serializing network...")
model.save("E:/Progs/Restore/modelcnns10_31   ", save_format="h5")
# save the single-label binarizer to disk
print("[INFO] serializing label binarizer...")
f = open("E:/Progs/Restore/labelbincnn_slabel10_31", "wb")
...
plt.ylabel("Loss")
plt.tight_layout()
plt.savefig("E:/Progs/Restore/ManuscriptDataset/Resultcnnslabel/plotcnnslabbel10_31")
plt.show()
